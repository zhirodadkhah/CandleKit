import pytest
import pandas as pd
from candlestick.entity import CandleStick
...
def test_is_doji():
    ...
    actual_small_doji = make_candle(100, 103, 99, 100.3)
    assert is_doji(actual_small_doji, max_body_ratio=0.1)

    large_body = make_candle(100, 110, 95, 105)
    assert not is_doji(large_body, max_body_ratio=0.1)

    zero_length = make_candle(100, 100, 100, 100)
...
def test_is_hammer():
    ...
    truly_large_body = make_candle(95, 98, 94, 97.5)
    assert not is_hammer(truly_large_body, max_body_ratio=0.25)

    short_lower = make_candle(95, 98, 94, 96)
    assert not is_hammer(short_lower)

    long_upper = make_candle(95, 105, 80, 96)
    assert not is_hammer(long_upper, max_upper_wick_ratio=0.33)

    bearish_hammer = make_candle(96, 98, 80, 95)
...
def test_is_shooting_star():
    ...
    very_short_upper = make_candle(105, 106.5, 103, 104)
    assert not is_shooting_star(very_short_upper)

    long_lower = make_candle(105, 120, 95, 104)
    assert not is_shooting_star(long_lower, max_lower_wick_ratio=0.33)

    bullish_star = make_candle(104, 120, 103, 105)
...
def test_is_bullish_belt_hold():
    ...
    large_bottom_wick = make_candle(102, 110, 99, 109)
...
def test_is_bearish_belt_hold():
    ...
    large_top_wick = make_candle(108, 110, 99, 100)
...
def test_is_bullish_engulfing():
    bearish = make_candle(105, 108, 102, 103)
    bullish = make_candle(102, 109, 101, 108)
    ...
    bearish1 = make_candle(105, 108, 102, 103)
    bullish_small = make_candle(103.5, 106, 103, 105)
...
def test_is_bearish_engulfing():
    bullish = make_candle(103, 108, 102, 107)
    bearish = make_candle(108, 109, 101, 102)
...
def test_is_piercing_line():
    ...
    bearish1 = make_candle(110, 112, 105, 106)
    bullish_wrong_open = make_candle(105.5, 108, 105, 108.1)
    assert not is_piercing_line(bearish1, bullish_wrong_open)

    bearish1 = make_candle(110, 112, 105, 106)
    bullish_below_mid = make_candle(104, 107, 103, 107.5)
    assert not is_piercing_line(bearish1, bullish_below_mid)

    bearish1 = make_candle(110, 112, 105, 106)
    bullish_above_open = make_candle(104, 111, 103, 111)
    assert not is_piercing_line(bearish1, bullish_above_open)


def test_is_dark_cloud_cover():
    bullish = make_candle(100, 105, 98, 104)
    bearish = make_candle(106, 107, 101, 101.5)
    ...
    bullish1 = make_candle(100, 105, 98, 104)
    bearish_wrong_open = make_candle(104.5, 107, 101, 101.5)
    assert not is_dark_cloud_cover(bullish1, bearish_wrong_open)

    bullish1 = make_candle(100, 105, 98, 104)
    bearish_above_mid = make_candle(106, 107, 101, 102.5)
    assert not is_dark_cloud_cover(bullish1, bearish_above_mid)

    bullish1 = make_candle(100, 105, 98, 104)
    bearish_below_open = make_candle(106, 107, 101, 99)
...
def test_is_harami_cross_bullish():
    ...
    bearish = make_candle(110, 115, 105, 106)
    not_doji = make_candle(107, 112, 106, 111)
    assert not is_harami_cross_bullish(bearish, not_doji)

    bearish = make_candle(110, 115, 105, 106)
    doji_outside = make_candle(104, 116, 103, 104)
    assert not is_harami_cross_bullish(bearish, doji_outside)

    truly_thin_bearish = make_candle(110, 112, 109, 110.5)
...
def test_is_harami_cross_bearish():
    ...
    bullish = make_candle(100, 105, 95, 104)
    doji_outside = make_candle(94, 106, 93, 94)
    assert not is_harami_cross_bearish(bullish, doji_outside)


def test_is_kicking_bullish():
    bearish_marubozu = make_candle(110, 110, 100, 100)
    bullish_marubozu = make_candle(111, 120, 111, 120)
    ...
    bearish1 = make_candle(110, 110, 100, 100)
    bullish_no_gap = make_candle(100.5, 120, 99, 120)
    assert not is_kicking_bullish(bearish1, bullish_no_gap)

    bearish1 = make_candle(110, 110, 100, 100)
    bullish_regular_gap = make_candle(100.5, 120, 100.5, 120)
    assert not is_kicking_bullish(bearish1, bullish_regular_gap)


def test_is_kicking_bearish():
    bullish_marubozu = make_candle(100, 110, 100, 110)
    bearish_marubozu = make_candle(99, 99, 90, 90)
    ...
    bullish1 = make_candle(100, 110, 100, 110)
    bearish_no_gap = make_candle(99, 101, 90, 90)
